                ...
                <div class="card-body">
                    <form action="{{ route('data-dosen.store') }}" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-2">
                                <label for="kode-dosen" class="mb-1">Kode dosen</label>
                                <input type="text" class="form form-control @error('kode_dosen') is-invalid @enderror"
                                    name="kode_dosen" id="kode-dosen" placeholder="" value="{{ old('kode_dosen') }}" required>
                                @error('kode_dosen')
                                    <div id="validationServer03Feedback" class="invalid-feedback">
                                        {{ $message }}
                                    </div>
