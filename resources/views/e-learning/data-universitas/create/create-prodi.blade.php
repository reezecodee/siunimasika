                        ...
                        <div class="row">
                            <div class="col-md-6 mb-2">
                                ...
                                <input type="text" class="form form-control @error('kode_prodi') is-invalid @enderror"
                                    name="kode_prodi" id="kode-prodi" placeholder="" required>
                                @error('kode_prodi')
                                    <div id="validationServer03Feedback" class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="col-md-6 mb-2">
                                ...
                                <input type="text" class="form form-control @error('nama_prodi') is-invalid @enderror"
                                    name="nama_prodi" id="nama-prodi" placeholder="" required>
                                @error('nama_prodi')
                                    <div id="validationServer03Feedback" class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="col-md-6 mb-2">
                                ...
                                <input type="text" class="form form-control @error('jenjang') is-invalid @enderror"
                                    name="jenjang" id="jenjang" placeholder="" required>
                                @error('jenjang')
                                    <div id="validationServer03Feedback" class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="col-md-6 mb-2">
                                ...
                                <select class="form form-select cursor-pointer @error('id_kampus') is-invalid @enderror" name="id_kampus" id="kampus" required>
