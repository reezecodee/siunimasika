...
@section('card-content')
    <div class="card">
        <div class="card-body">
            <form action="{{ route('data-kampus.update', $dataKampus->id) }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <input type="file" name="picture" value="{{ $dataKampus->picture }}" id="picture"
                    ...
                    <div class="col-md-8">
                        <div class="row">
                            <div class="col-md-6 mb-2">
                                ...
                                <input type="text" class="form form-control @error('kode_pt') is-invalid @enderror"
                                    name="kode_pt" id="kode-kampus" value="{{ $dataKampus->kode_pt }}" placeholder=""
                                    required>
                                @error('kode_pt')
                                    <div id="validationServer03Feedback" class="invalid-feedback">
                                        {{ $message }}
                            ...
                            <div class="col-md-6 mb-2">
                                ...
                                <input type="text" class="form form-control @error('nama_pt') is-invalid @enderror"
                                    name="nama_pt" id="nama-kampus" value="{{ $dataKampus->nama_pt }}" placeholder=""
                                    required>
                                @error('nama_pt')
                                    <div id="validationServer03Feedback" class="invalid-feedback">
                                        {{ $message }}
                            ...
                            <div class="col-md-6 mb-2">
                                ...
                                <select class="form form-select cursor-pointer @error('kategori') is-invalid @enderror"
                                    ...
                                    <option value="{{ $dataKampus->kategori }}" selected>{{ $dataKampus->kategori }}
                                    </option>
                            ...
                            <div class="col-md-6 mb-2">
                                ...
                                <select class="form form-select cursor-pointer @error('status') is-invalid @enderror"
                                    ...
                                    <option value="{{ $dataKampus->status }}" selected>{{ $dataKampus->status }}</option>
                            ...
                            <div class="col-md-6 mb-2">
                                ...
                                <input type="text" class="form form-control @error('telepon') is-invalid @enderror"
                                    name="telepon" id="telepon-kampus" value="{{ $dataKampus->telepon }}" placeholder=""
                                    required>
                                @error('telepon')
                                    <div id="validationServer03Feedback" class="invalid-feedback">
                                        {{ $message }}
                            ...
                            <div class="col-md-6 mb-2">
                                ...
                                <input type="email" class="form form-control @error('email') is-invalid @enderror"
                                    name="email" id="email-kampus" value="{{ $dataKampus->email }}" placeholder=""
                                    required>
                                @error('email')
                                    <div id="validationServer03Feedback" class="invalid-feedback">
                                        {{ $message }}
                            ...
                            <div class="col-md-6 mb-2">
                                ...
                                <input type="date"
                                    ...
                                    value="{{ $dataKampus->tanggal_berdiri }}" required>
                        ...
                        <textarea class="form form-control @error('alamat') is-invalid @enderror" name="alamat" id="alamat"
                            value="{{ $dataKampus->alamat }}" rows="5">{{ $dataKampus->alamat }}</textarea>
                        @error('alamat')
                            <div id="validationServer03Feedback" class="invalid-feedback">
                                {{ $message }}
                            </div>
