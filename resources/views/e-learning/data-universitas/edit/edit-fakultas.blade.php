...
@section('card-content')
    <div class="card">
        <div class="card-body">
            <form action="{{ route('data-fakultas.update', $dataFakultas->id) }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-2">
                                ...
                                <input type="text" class="form form-control @error('kode_fk') is-invalid @enderror"
                                    name="kode_fk" id="kode-fakultas" placeholder="" value="{{ $dataFakultas->kode_fk }}"
                                    required>
                                @error('kode_fk')
                                    <div id="validationServer03Feedback" class="invalid-feedback">
                                        {{ $message }}
                            ...
                            <div class="col-md-6 mb-2">
                                ...
                                <input type="text" class="form form-control @error('nama_fk') is-invalid @enderror"
                                    name="nama_fk" id="nama-fakultas" placeholder="" value="{{ $dataFakultas->nama_fk }}"
                                    required>
                                @error('nama_fk')
                                    <div id="validationServer03Feedback" class="invalid-feedback">
                                        {{ $message }}
                            ...
                            <div class="col-md-6 mb-2">
                                ...
                                <select class="form form-select cursor-pointer @error('status') is-invalid @enderror"
                                    ...
                                    <option value="{{ $dataFakultas->status }}" selected>{{ $dataFakultas->status }}
                                    </option>
                            ...
                            <div class="col-md-6 mb-2">
                                ...
                                <select class="form form-select cursor-pointer @error('id_kampus') is-invalid @enderror"
                                    ...
                                    <option value="{{ $dataFakultas->universitas->id }}" selected>
                                        {{ $dataFakultas->universitas->nama_pt }}</option>
                            ...
                            <div class="col-md-6 mb-2">
                                ...
                                <select class="form form-select cursor-pointer @error('id_dekan') is-invalid @enderror"
                                    ...
                                    <option value="{{ $dataFakultas->dekan->id }}" selected>
                                        {{ $dataFakultas->dekan->nama }}</option>
