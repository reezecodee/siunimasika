                ...
                <div class="col-md-12">
                    <div class="row">
                        <div class="col-md-12 mb-2">
                            ...
                            <input type="text" class="form form-control" value="{{ $dataKelas->universitas->nama_pt }}"
                                readonly disabled id="nama-kampus">
                        </div>
                        <div class="col-md-6 mb-2">
                            <label for="kode-kelas" class="mb-1">Kode kelas</label>
                            <input type="text" class="form form-control" value="{{ $dataKelas->kode_kelas }}" readonly
                                disabled id="kode-kelas">
                        </div>
                        <div class="col-md-6 mb-2">
                            <label for="nama-kelas" class="mb-1">Nama kelas</label>
                            <input type="text" class="form form-control" value="{{ $dataKelas->nama_kelas }}" readonly
                                disabled id="nama-kelas">
                        </div>
                        <div class="col-md-6 mb-2">
                            <label for="nama-fakultas" class="mb-1">Fakultas</label>
                            <input type="text" class="form form-control" value="{{ $dataKelas->fakultas->nama_fk }}"
                                readonly disabled id="nama-fakultas">
                        </div>
                        <div class="col-md-6 mb-2">
                            <label for="status-kelas" class="mb-1">Status kelas</label>
                            <input type="text" class="form form-control" value="{{ $dataKelas->status }}" readonly
                                disabled id="status-kelas">
                        </div>
                        <div class="col-md-6 mb-2">
                            <label for="daya-tampung" class="mb-1">Daya tampung</label>
                            <input type="text" class="form form-control" value="{{ $dataKelas->daya_tampung }}" readonly
                                disabled id="daya-tampung">
                        </div>
                        <div class="col-md-6 mb-2">
                            <label for="dosenPA" class="mb-1">Dosen pembimbing akademik</label>
                            <input type="text" class="form form-control" value="{{ $dataKelas->dosenPA->nama }}" readonly
                                disabled id="dosenPA">
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="d-flex justify-content-end align-items-center gap-2">
                        ...
                        <button class="btn btn-outline-primary">Total: {{ $dataMahasiswa->count() }}</button>
                    </div>
